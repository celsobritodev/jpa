...
CREATE TABLE `tb_author` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK6f7pu6hq7r5byjx9gfb04dh27` (`name`)
...
INSERT INTO `tb_author` VALUES (_binary '\‰\‡L{F\'\Ôñ\È¿Mt~','Eric Evans'),(_binary '\‰\‚~F\'\Ôñ\È¿Mt~','Marvey Deitel'),(_binary '\‰\·	F\'\Ôñ\È¿Mt~','Paul Deitel');
